...
public final class Inceptionv3 {
  @NonNull
  private final Model model;

  private Inceptionv3(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "inceptionv3.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Inceptionv3 newInstance(@NonNull Context context) throws IOException {
    return new Inceptionv3(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Inceptionv3 newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new Inceptionv3(context, options);
  }
